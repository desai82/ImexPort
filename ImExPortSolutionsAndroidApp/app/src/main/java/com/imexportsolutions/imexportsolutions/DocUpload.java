...
public class DocUpload extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        SharedPreferences sp = PreferenceManager.getDefaultSharedPreferences(DocUpload.this);
    ...
    private class MyDocUpload extends AsyncTask<String,String,String > {
        ...
        protected String doInBackground(String... strings) {
         ...
         if(Country.equals("INDIA")) {
             ...
             rp.setMethod("POST");
             rp.setUri(HttpManager.URL + "PortClearanceDocsICA");
             String photoupload = convertBitmapToString(photo);
             ...
             RequestPackage rp = new RequestPackage();
             rp.setMethod("POST");
             rp.setUri(HttpManager.URL + "PortClearanceDocsFCA");
             String photoupload = convertBitmapToString(photo);
             rp.setParam("photoupload", photoupload);
             rp.setParam("POID", ID1);
             String ans = HttpManager.getData(rp);
        ...
        protected void onPostExecute(String ans) {
           ...
           // int ID = Integer.parseInt(ans);
            ...
            if (ans.equals("Success")) {
                ...
                Intent i = new Intent(DocUpload.this, ReceivedPODetails.class);
                i.putExtra("ID",ID1);
                i.putExtra("flag",1);
                startActivity(i);
                finish();
